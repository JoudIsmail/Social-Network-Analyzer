...
public class ViewControllerMainTwitter {
    ...
    public void showAccountDisplay() {
        ...
        presenterMainTwitter.requestUserTweets(TwitterInformation.orderTypeStrings[0], TwitterInformation.timeFrameStrings[0], 100,
                displayingSelf);
        presenterMainTwitter.requestMentionsTweets(TwitterInformation.orderTypeStrings[0], TwitterInformation.timeFrameStrings[0],
                100, displayingSelf);
    }
    ...
    public void showAuthenticationDisplay(String authenticationURL) {
        ...
        try {
            ...
            this.presenterMainTwitter.requestAuthentication(pin);
        } catch (IOException e) {
